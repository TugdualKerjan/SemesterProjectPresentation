...
from few_shot.config import DATA_PATH
...
class OmniglotDataset(Dataset):
    def __init__(self, subset):
        ...
        # List of all unique characters "Tifinagh.180.character25"
        self.unique_characters = sorted(self.df['class_name'].unique())
        # Assign an id  'Tifinagh.180.character25': 3715,
    ...
    def __getimage__(self, filepath: str):
        instance = io.imread(filepath)
        # Reindex to channels first format as supported by pytorch
        instance = instance[np.newaxis, :, :]
    ...
    def __getclassid__(self, class_name: str):
        return self.class_name_to_id[class_name]

    def __getlabel__(self, item):
        return self.datasetid_to_class_id[item]
